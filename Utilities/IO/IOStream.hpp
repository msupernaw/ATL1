...
namespace atl {
    ...
    public:
            ...
            while (input.good()) {
                ...
                if (!util::StartsWith(line, "#")) {
                    ...
                    for (int i = 0; i < tokens.size(); i++) {
                        ...
                        this->data_m.push_back(tokens.at(i));
                    }
        ...
        TT Next() {
//            util::StringToNumber<T > (tokens.at(i)))
            if (this->data_index_m< this->data_m.size()) {
                this->data_index_m++;
                return this->data_m.at(util::StringToNumber<TT> (this->data_index_m - 1));
            }
            return 0;
        }
...
//            util::StringToNumber<T > (tokens.at(i)))
            if (this->data_index_m< this->data_m.size()) {
                this->data_index_m++;
                return util::StringToNumber<T > (this->data_m.at(this->data_index_m - 1));
            }
            return 0;
        }
